  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.88)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:100,padding:20}}>
      <div className="bIn" style={{...S.card,width:"100%",maxWidth:380,padding:24}}>
        <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:18,fontWeight:700,marginBottom:6}}>{t('resolve.title')}</div>
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.88)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:100,padding:20}}>
      <div className="bIn" style={{...S.card,width:"100%",maxWidth:360,padding:24,textAlign:"center"}}>
        <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:20,fontWeight:700,marginBottom:6}}>{t('overtime.title')}</div>
        ...
        {phase==="result"&&winner&&(
          <div className="bIn">
            <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontWeight:700,color:"var(--gold)",marginBottom:8}}>{profiles[winner]?.avatar} {profiles[winner]?.name} {t('overtime.winner')}</div>
