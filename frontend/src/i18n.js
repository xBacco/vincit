...
const TRANSLATIONS = {
  it: {
    ...
    app:     { welcome_back:'Bentornato', credits:'Crediti', switch:'Switch', new_bet:'+ Nuova Bet', new_bet_label:'Nuova', new_group:'+ Nuovo gruppo', error_create:'Errore nella creazione della bet. Riprova.', error_cancel:"Errore durante l'annullamento. Riprova.", error_edit:'Errore durante la modifica. Riprova.', error_reset:'Errore durante il reset. Riprova.', error_accept:"Errore durante l'accettazione. Riprova.", error_reject:'Errore durante il rifiuto. Riprova.', reject_confirm:'Rifiutare questa bet?', sync_error:'Errore di sincronizzazione — tocca per riprovare' },
    ...
    bet_card: {
      ...
      surprise_label:'🤫 Sorpresa', targeted_vs:'🎯 vs {name}',
  ...
  en: {
    ...
    bet_card: {
      ...
      surprise_label:'🤫 Surprise', targeted_vs:'🎯 vs {name}',
